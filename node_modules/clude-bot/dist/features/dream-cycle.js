...
async function runConsolidation() {
    ...
    for (const question of focalPoints) {
        ...
        const response = await (0, claude_client_1.generateResponse)({
            ...
            featureInstruction: 'You are Clude reflecting on a specific question about your experience. ' +
...
async function runDirectConsolidation(recentEpisodic) {
    ...
    const response = await (0, claude_client_1.generateResponse)({
        ...
        featureInstruction: 'You are Clude reviewing your own memories during a consolidation cycle. ' +
...
async function runReflection() {
    ...
    const response = await (0, claude_client_1.generateResponse)({
        ...
        context,
        featureInstruction: 'You are Clude in a reflection cycle. You are examining your own behavior patterns, ' +
...
async function extractProceduralInsights(recentEpisodic) {
    ...
    try {
        const response = await (0, claude_client_1.generateResponse)({
            ...
            featureInstruction: 'You are Clude extracting behavioral patterns from your own interaction history. ' +
