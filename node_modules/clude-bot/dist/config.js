...
function isSDK() {
    return !!globalThis.__CLUDE_SDK_MODE;
}
...
function requiredUnlessSiteOnly(key) {
    if (isSDK() || siteOnly)
        return process.env[key] || '';
    return required(key);
}
...
exports.config = {
    ...
    inference: {
        ...
        primary: optional('INFERENCE_PRIMARY', 'auto'),
        /** Fallback provider if primary fails */
        fallback: optional('INFERENCE_FALLBACK', 'anthropic'),
    },
    activity: {
